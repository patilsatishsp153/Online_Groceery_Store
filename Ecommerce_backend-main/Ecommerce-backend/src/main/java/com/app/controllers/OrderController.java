...
public class OrderController {
	...
	public ResponseEntity<?> placeOrder(@PathVariable int cid, @PathVariable int pid, @PathVariable int qty,
		...
		text.append("We recieved your order, this order will be deliverd within a 24 hour on adderss.\n"
		...
		placeOrder.getDetails().forEach((detail) -> {
			...
			text.append("Total price : Rs " + detail.getTotalPrice() + "\n");
		});
		text.append("Thanks for choosing our Grocery Store...!!\n");
